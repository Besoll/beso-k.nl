...
const titleBL = 'Website Development';
const urlBL = 'https://besok.nl/website-development';
const imageBL = 'https://besok.nl/_next/image?url=%2Fhero.webp&w=3840&q=75';
const descriptionBL = 'Custom Next.js websites: fast, secure, with advanced animations and full SEO optimization.';
