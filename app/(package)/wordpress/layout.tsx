...
const titleBL = 'Wordpress';
const urlBL = 'https://besok.nl/wordpress';
const imageBL = 'https://besok.nl/_next/image?url=%2Fhero.webp&w=3840&q=75';
const descriptionBL = 'Professionally developed, responsive WordPress websites for businesses aiming to grow online.';
